...
<body>
    <div class="admin-batch-container">
        ...
        <div class="admin-batch-button">
            <a href="taskCreate.php" class="admin-batch-bLink">Create New Batch</a>
        ...
        <table class="admin-batch-tableOuter">
            <thead>
                ...
                <tr>
                    ...
                    <th class="admin-batch-tableHead">Skill</th>
                    <th class="admin-batch-tableHead">State</th>
                    <th class="admin-batch-tableHead">Message</th>
                    <th class="admin-batch-tableHead">CreatedTime</th>
            ...
            <tbody>
                ...
                ?>
                        ...
                        <tr>
                            ...
                            <td class="admin-batch-tableData"><?= $record['skill'] ?></td>
                            <td class="admin-batch-tableData"><?= $record['state'] ?></td>
                            <td class="admin-batch-tableData"><?= $record['message'] ?></td>
                            <td class="admin-batch-tableData"><?= $record['createdTime'] ?></td>

                            <td class="admin-batch-tableData">
                                <a href="taskUpdate.php?id= <?= $record['id'] ?>" class="admin-batch-actionLink">
                                    <i class="fa fa-edit"></i>

                                </a>
                                <a href="taskDelete.php?id= <?= $record['id'] ?>" class="">
